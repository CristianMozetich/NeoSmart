...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r dark:from-tertiarySlate to-secondarySlate text-fillicon p-6 dark:text-white border-t border-solid border-sidebarPink dark:border-none">
      <div>
